...
class TransaksiController extends Controller
{
    ...
    {
        if ($request->ajax()) {
            return DataTables::eloquent(Peminjaman::with('mobil', 'user')->select('id', 'user_id', 'mobil_id', 'tanggal_awal', 'tanggal_akhir', 'tarif', 'status')->orderBy('tanggal_akhir', 'ASC')->orderBy('status', 'ASC'))
                ->addIndexColumn()
