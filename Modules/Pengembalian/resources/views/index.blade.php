    ...
    <script>
        ...
        $(document).on("click", ".lihat", function() {
            id = $(this).data("id"), $.post("{{ route($attribute['link'] . 'data') }}", {
                ...
                a.status ? (
                    $("#textMerek").html(a.merek),
                    $("#textModel").html(a.model),
                    $("#textPlat").html(a.plat),
                    $("#textTanggalAwal").html(a.awal),
                    $("#textTanggalAkhir").html(a.akhir),
                    $("#textTanggalSaatIni").html(a.ini),
                    $("#textTarif").html(a.tarif),
        ...
        $("#formPengembalian").submit(function() {
            id ? $.post("{{ route($attribute['link'] . 'selesai') }}", {
                id: id,
            }, function(a) {
                a.status ? (id = null, alertApp("success", a.message), $(
                    "#modalPengembalian").modal("hide")) : alertApp("error", a.message)
            }).fail(function(a, t, e) {
                alertApp("error", e)
